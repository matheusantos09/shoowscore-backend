...
import { HttpMethod, AuthenticationToken, RequestOptions, RequestParams, SessionRequestParams, SessionResponse, QueueItem } from './types'
import * as types from './interfaces'

export class ShoowDb {
  ...
  private static parseSearchParams ( params: string | types.SearchRequest ): types.SearchRequest | string | object {
    if (isString(params)) {
      return { query: params }
    }
  ...
  get ( endpoint: string, axiosConfig?: AxiosRequestConfig ): Promise<types.ConfigurationResponse> {
  ...
  searchCompany ( params: string | types.SearchRequest, axiosConfig?: AxiosRequestConfig ): Promise<types.SearchCompanyResponse> {
    return this.makeRequest(HttpMethod.Get, 'search/company', ShoowDb.parseSearchParams(params), axiosConfig)
  }

  searchCollection ( params: types.SearchRequest, axiosConfig?: AxiosRequestConfig ): Promise<types.SearchCollectionResponse> {
    return this.makeRequest(HttpMethod.Get, 'search/collection', ShoowDb.parseSearchParams(params), axiosConfig)
  }

  searchKeyword ( params: types.SearchRequest, axiosConfig?: AxiosRequestConfig ): Promise<types.SearchKeywordResponse> {
    return this.makeRequest(HttpMethod.Get, 'search/keyword', ShoowDb.parseSearchParams(params), axiosConfig)
  }

  searchMovie ( params: types.SearchMovieRequest, axiosConfig?: AxiosRequestConfig ): Promise<types.MovieResultsResponse> {
    return this.makeRequest(HttpMethod.Get, 'search/movie', ShoowDb.parseSearchParams(params), axiosConfig)
  }

  searchMulti ( params: types.SearchMultiRequest, axiosConfig?: AxiosRequestConfig ): Promise<types.SearchMultiResponse> {
    return this.makeRequest(HttpMethod.Get, 'search/multi', ShoowDb.parseSearchParams(params), axiosConfig)
  }

  searchPerson ( params: types.SearchMultiRequest, axiosConfig?: AxiosRequestConfig ): Promise<types.SearchPersonResponse> {
    return this.makeRequest(HttpMethod.Get, 'search/person', ShoowDb.parseSearchParams(params), axiosConfig)
  }

  searchTv ( params: types.SearchTvRequest, axiosConfig?: AxiosRequestConfig ): Promise<types.TvResultsResponse> {
    return this.makeRequest(HttpMethod.Get, 'search/tv', ShoowDb.parseSearchParams(params), axiosConfig)
  }
  ...
  movieLatest ( params?: object | string | RequestParams, axiosConfig?: AxiosRequestConfig ): Promise<types.MovieResponse> {
   ...
   */
  private normalizeOptions ( options: string | RequestOptions = {} ): RequestOptions | string | object {
    if (isString(options)) {
  ...
  private makeRequest (
    ...
    const normalizedParams: RequestParams | string | number = this.normalizeParams(endpoint, params)
